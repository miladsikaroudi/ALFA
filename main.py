...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default='./algorithms/mDSDI_ssl/configs/RCC_nci.json', help="Path to configuration file")
    ...
    wandb.init(config = wandb.config, project= project_name, entity="msikarou", name=str(args.exp_name + '/' + args.algorithm))
